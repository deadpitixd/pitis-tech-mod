...
public class BarrelMenu extends AbstractContainerMenu {
    ...
    public BarrelMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData){
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(8));
    }

    public BarrelMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data){
